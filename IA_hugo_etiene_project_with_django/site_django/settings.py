...
SECRET_KEY = 'django-insecure-8fyid^6-inq&#ku@gqos*mx71j@v0na+dkda0+usx$k=#hihz@'
...
# Configurations pour Allauth
SITE_ID = 1
ACCOUNT_EMAIL_REQUIRED = True
ACCOUNT_USERNAME_REQUIRED = True
ACCOUNT_LOGIN_METHOD = {'username'}
LOGIN_REDIRECT_URL = '/site/pool_settings/'
...
MIDDLEWARE = [
    ...
    # Add this line to enable allauth middleware
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "blog/templates"],  # Assurez-vous que le chemin est correct
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
